...
| **v2** | 🚧 6.1 ИСПОЛНЕНА (c999e12: токен-слой — references/rgba в gen:tokens, дельты/таблица/крем/регистры; 6 dark first-pass [ASSUMPTION] → 8.2). Далее: 6.2+6.3 (батч спеков) |
...
3. Стори 6.1 по циклу §5 — ✅ исполнена 2026-09-24 (spec-6-1 закрыт, c999e12;
   ...
   на v2-строках DESIGN.md; 6.1 этот шов закрыла). Следующая: 6.2+6.3 (батч спеков).
