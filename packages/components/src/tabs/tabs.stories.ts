    ...
    <main class="tkt-canvas">
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Tab на ленту</td>
            <td>«Дебетовая карта, вкладка, выбрана, 1 из 3» — имя включает счётчик бейджа, если есть</td>
          </tr>
          <tr>
            <td>ArrowRight / ArrowLeft</td>
            <td>вкладка объявляется и АКТИВИРУЕТСЯ: контент панели меняется вместе с фокусом</td>
          </tr>
          <tr>
            <td>Home / End</td>
            <td>первая / последняя вкладка</td>
          </tr>
          <tr>
            <td>Tab в панель</td>
            <td>читается содержимое активной панели; неактивные панели недостижимы</td>
          </tr>
        </tbody>
      </table>
    </main>
...
export const Api: Story = {
  name: 'API',
  render: () => apiReferenceDoc('tk-tabs'),
};
