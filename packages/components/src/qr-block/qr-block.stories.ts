    ...
    <main class="tkq-canvas">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Блок с абзацем page-copy (вторая фигура демо)</td>
            <td>
              «Вариант 2. Отсканируйте QR-код, заголовок 2-го уровня»; затем
              «Переходите по ссылкам только с этой страницы…» — обычный абзац
              ДО «панель переключателя вкладок»; копия не меняет ни роль
              вкладок, ни их порядок
            </td>
          </tr>
        </tbody>
      </table>
