    ...
    <main class="tkp-canvas">
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Tab на сетку</td>
            <td>«Выберите дизайн карты, группа радио, Чёрная, радио-кнопка, выбрана 1 из 6»</td>
          </tr>
          <tr>
            <td>Стрелки</td>
            <td>переход по плиткам построчно; каждая объявляется именем + «выбрана» при активации</td>
          </tr>
          <tr>
            <td>Выбор</td>
            <td>имя выбранной плитки озвучивается при смене (радио-семантика)</td>
          </tr>
        </tbody>
      </table>
    </main>
