  ...
  render: (args) => html`
    ...
    <main class="tkb-canvas">
      ...
      <p class="tkb-note">
        ...
        surface-muted 324×80 radius-xl, слева — название магазина (голое
    ...
    <main class="tkb-canvas">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Скринридер</td>
            <td>«RuStore, ссылка» — голое имя магазина; иконка по умолчанию декоративная (alt="") и не добавляет второго объявления имени, явный iconAlt переопределяет.</td>
          </tr>
        </tbody>
      </table>
      <div class="tkb-panel">
