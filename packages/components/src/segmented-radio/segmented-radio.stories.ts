    ...
    <main class="tkr-canvas">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Tab на sr-only-группу (второй ряд демо)</td>
            <td>
              «Тип операции, группа радио, Да, радио-кнопка, выбрана 1 из 2» —
              имя скрытой метки то же, что у видимой подписи; резервное имя
              «Выбор» НЕ срабатывает (labelledby выигрывает у aria-label)
            </td>
          </tr>
        </tbody>
      </table>
