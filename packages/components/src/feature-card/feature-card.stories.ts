...
export const Playground: Story = {
  ...
  render: (args) => html`
    ...
    <main class="tkfc-canvas">
      <h1>FeatureCard</h1>
      <p class="tkfc-note">
        Большая 2-up карточка эталона: радиус xxl 24 (5.6: пиксель-проба
        архива 22–24, вижн-оценка 32 отменена), минимальная высота 320,
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>карта пассивна: «<Заголовок>, заголовок 3 уровня», описание, затем действие</td>
          </tr>
          <tr>
            <td>Tab</td>
            <td>останавливается только на CTA-кнопке; editorial-вариант объявляется так же</td>
          </tr>
        </tbody>
      </table>
    </main>
...
export const Api: Story = {
  name: 'API',
  render: () => apiReferenceDoc('tk-feature-card'),
};
