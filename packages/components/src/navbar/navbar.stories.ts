      ...
      <main>
        <div class="tkn-demo">
          ...
          <p class="tkn-note">
            ...
            ПОСЛЕДНЕЙ строкой. Активная ссылка строки 2 — вес 700 и
            чернильный цвет, БЕЗ подчёркивания: язык штриха не каскадирует
            вниз (замороженное решение; фактическая серая полоса эталона
            у нижней кромки строки 2 записана как отклонение в
            verify/mega-nav/NOTES.md). Разделителя между
            строками нет — разделение белым полем (замороженное решение
            спецификации; фактическая светло-серая волосяная линия эталона
            на y64 записана как отклонение в verify/mega-nav/NOTES.md).
            Ряд 2
...
export const Api: Story = {
  name: 'API',
  render: () => apiReferenceDoc('tk-navbar'),
};
