...
export const Playground: Story = {
  ...
  render: (args) => html`
    ...
    <main class="tkpc-canvas">
      <h1>PromoCard</h1>
      <p class="tkpc-note">
        Пастельная маркетинговая карточка эталона: радиус xxl 24 (5.6:
        пиксель-проба архива 22–24, вижн-оценка 32 отменена), паддинг 32,
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>карта НЕ интерактивна: заголовок «Т-Инвестиции, заголовок 3 уровня», затем описание</td>
          </tr>
          <tr>
            <td>Tab</td>
            <td>единственная остановка — CTA-кнопка: «Подробнее, кнопка»; сама карта в порядке табуляции отсутствует</td>
          </tr>
          <tr>
            <td>bleed-карта (второй столбец демо)</td>
            <td>
              «Т-Бизнес, заголовок 3 уровня», затем описание; арт bleed НЕ
              объявляется (aria-hidden на стороне потребителя); Tab —
              «Подробнее, кнопка» — имя слотленной кнопки, порядок таба
              не меняется
            </td>
          </tr>
        </tbody>
...
export const Api: Story = {
  name: 'API',
  render: () => apiReferenceDoc('tk-promo-card'),
};
