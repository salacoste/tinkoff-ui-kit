...
`playwright --list`): сюита **392 PNG + 22 per-component PNG в 11
per-component-директориях (12-я директория снапшотов — сама сюита,
`visual.spec.ts-snapshots`) = 414 всего — ФАЙЛОВ НЕ ПРИБЫЛО** (ни одного нового/удалённого PNG за окно;
