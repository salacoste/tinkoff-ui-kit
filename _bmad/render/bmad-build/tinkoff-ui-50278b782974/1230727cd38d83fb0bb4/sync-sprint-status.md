Set `development_status[{story_key}]` to `{target_status}` in `/Users/r2d2/Documents/Code_Projects/ui-kits/tinkoff-ui/_bmad-output/implementation-artifacts/sprint-status.yaml`.
