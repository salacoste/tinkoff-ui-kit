...
## Итоги v2-ситтинга (гейт §8.1.4 релиза v1.1.0 — 2026-09-25)

Девять v2-компонентов; прогон по run-sheet
`.playwright-cli/verify/a11y-sweep/SR-RUNSHEET-v2.md` (живая сессия VoiceOver,
мейнтейнер; story-URL обеих тем, `serve.mjs 6009`). Story-ID и дословные
ожидаемые объявления — в run-sheet; здесь — итоговая таблица (нумерация
продолжает v1-ситтинг выше).

| № | Группа | Компонент | Вердикт (соотв. / отклонение) | Наблюдения (№/ссылка) |
|---|---|-----------|-------------------------------|------------------------|
| 20 | v2 | tk-filter-chips | соответствует (VO, 2026-09-25, light+dark) | — |
| 21 | v2 | tk-pagination | соответствует (VO, 2026-09-25, light+dark) | — |
| 22 | v2 | tk-combobox-search | соответствует (VO, 2026-09-25, light+dark) | — |
| 23 | v2 | tk-data-table | соответствует (VO, 2026-09-25, light+dark) | — |
| 24 | v2 | tk-navbar (мега-нав) | соответствует (VO, 2026-09-25, light+dark) | — |
| 25 | v2 | tk-cookie-banner | соответствует (VO, 2026-09-25, light+dark) | — |
| 26 | v2 | tk-stepper | соответствует (VO, 2026-09-25, light+dark) | — |
| 27 | v2 | tk-store-badges | соответствует (VO, 2026-09-25, light+dark) | — |
| 28 | v2 | tk-qr-block | соответствует (VO, 2026-09-25, light+dark) | — |

**18/18 ног ✓ (9 × light/dark), отклонений нет** (вердикт мейнтейнера «все ок»).
NVDA — прежнее осознанное отложение (нет Windows-машины, решение 2026-09-23).
Гейт RELEASE.md §8.1.4 закрыт этим ситтингом.
