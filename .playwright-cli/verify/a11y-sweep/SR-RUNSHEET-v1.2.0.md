...
- Ожидаемые анонсы (RU, дословно из протокола):
  1. Tab на первое поле → «Фамилия, имя и отчество, плюс 30 процентов, поле редактирования текста» — бейдж ПОСЛЕ подписи
  ...
  3. sr-only-поле с бейджем → «Телефон, плюс 30 процентов, поле редактирования текста»
