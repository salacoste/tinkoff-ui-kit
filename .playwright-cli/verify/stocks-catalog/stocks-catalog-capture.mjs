// Story 6.5 side-by-side kit renders — COMMITTED capture recipe (NOTES.md).
...
//   node .playwright-cli/verify/stocks-catalog/stocks-catalog-capture.mjs
...
for (const dark of [false, true]) {
  ...
  // resting page is the artifact. Viewport shot (1280×800) = the same frame
  // as the reference crop (captures-v2/invest-stocks/full.png, top 800px).
  const params = new URLSearchParams({
    id: 'showcase-stocks-catalog--stocks-catalog',
    viewMode: 'story',
  });
  ...
  await page.screenshot({ path: `${OUT}kit-page-${suffix}.png` });
